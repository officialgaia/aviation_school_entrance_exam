...
const SUBJECT_LABEL: Record<Subject, string> = { math: '数学', physics: '物理', english: '英語' };
const SUBJECT_ORDER: Subject[] = ['math', 'physics', 'english'];
...
export default function TextbookPage() {
  ...
  const bySubject: Record<Subject, typeof data.textbooks> = { math: [], physics: [], english: [] };
